...
- (void)layoutSubviews {
    ...
    if ([[UIDevice currentDevice].systemVersion intValue] >= 7.0) {
        NSDictionary *fontAttr = [NSDictionary dictionaryWithObjectsAndKeys:label.font, NSFontAttributeName, nil];
        labelSize = [label.text boundingRectWithSize:CGSizeMake(CGFLOAT_MAX, CGRectGetHeight(label.frame)) options:NSStringDrawingUsesLineFragmentOrigin attributes:fontAttr context:nil].size;
    }
